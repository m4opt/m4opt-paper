...
The centers of the fields are the vertices of a $\{3,5+\}_{21,4}$ icosahedral geodesic polyhedron (see Fig.~\ref{fig:skygrid}). This grid ensures that all of the fields cover the sky without gaps, regardless of roll angle.
