...
\begin{deluxetable*}{lrcccccccccccrc}
    ...
    \tablenotetext{c}{Cartesian coordinates (Mm) of the spacecraft in the \ac{ITRS} frame.}
    \tablenotetext{d}{Target location (deg) in the \ac{ICRS} frame.}
    ...
    \tablenotetext{h}{Median dust extinction (AB mag) in band over this field.}
    \tablenotetext{i}{Median sky brightness (AB mag arcsec$^-2$) over this field.}
    \tablenotetext{j}{Contribution by this field to the probability of detection.}
...
\software{
    ...
    \texttt{m4opt} \citep{leo_singer_2025_14931967},
