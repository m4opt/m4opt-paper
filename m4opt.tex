...
\end{itemize}
%
Coincidentally, our trigger and detection rates in Table~\ref{tab:selected-detected} are consistent with the highest and most optimistic estimates in \citet{2025arXiv250114109C}. Although by itself this comparison is not informative on the merits of these two strategies, it is a positive result for the prospects of \ac{KN} detection with \ac{UVEX}.
