...
\begin{deluxetable*}{lrccccccc}
    ...
    \tablehead{
        &&& \multicolumn3c{Spacecraft location (ITRS, km)\tablenotemark{a}}
        & \multicolumn3c{Target (ICRS, deg)\tablenotemark{b}} \\
    ...
    \enddata
    \tablenotetext{a}{The spacecraft location is given in Cartesian coordinates in the \ac{ITRS}, which is a geocentric coordinate system.}
    \tablenotetext{b}{The target location is given in the \ac{ICRS}.}
\end{deluxetable*}
