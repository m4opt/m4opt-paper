...
%
\begin{itemize}
    \item We threw out events with $m_2 > 3 M_\odot$ so that our sample would have little contamination by \ac{BBH} mergers that cannot produce \acp{KN}.
